      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="mb-4 md:mb-0">
                ...
                <p className="mt-1 text-white/80 text-sm">Season 2024-25</p>
              </div>
              <div className="flex items-center space-x-4">
                <div className="bg-white/10 rounded-lg px-4 py-2">
                  ...
                  {lastUpdate && (
                    <p className="text-xs text-white/60 mt-1">Last update: {lastUpdate}</p>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Top Budget-Friendly Picks (Under £7.0m)
          </h2>
        ...
        {!loading && players.allPlayers.length === 0 && !error && (
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <p className="text-gray-500 text-lg">No player data available at the moment</p>
            </div>
          </div>
        )}
        ...
        <div className="mt-12 mb-8">
          <div className="bg-white/40 rounded-xl p-1">
            <MatchFixtures matchweek={currentMatchweek} fixtures={fixtures} />
          </div>
        </div>
      </div>
    </main>
